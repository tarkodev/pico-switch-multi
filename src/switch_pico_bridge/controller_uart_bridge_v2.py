...
PRESET_COLORS: Dict[str, Tuple[Tuple[int, int, int], Tuple[int, int, int]]] = {
    "blue": ((0x00, 0x00, 0xFF), (0x00, 0x00, 0xFF)),
    "red": ((0xFF, 0x00, 0x00), (0xFF, 0x00, 0x00)),
    "green": ((0x00, 0xFF, 0x00), (0x00, 0xFF, 0x00)),
    "yellow": ((0xFF, 0xFF, 0x00), (0xFF, 0xFF, 0x00)),
    "purple": ((0x80, 0x00, 0xFF), (0x80, 0x00, 0xFF)),
    "orange": ((0xFF, 0x80, 0x00), (0xFF, 0x80, 0x00)),
    "cyan": ((0x00, 0xFF, 0xFF), (0x00, 0xFF, 0xFF)),
    "pink": ((0xFF, 0x00, 0xFF), (0xFF, 0x00, 0xFF)),
    "black": ((0x20, 0x20, 0x20), (0x20, 0x20, 0x20)),
    "white": ((0xF4, 0xF4, 0xF4), (0xF4, 0xF4, 0xF4)),
    "gray": ((0x80, 0x80, 0x80), (0x80, 0x80, 0x80)),
    "p0": ((0x00, 0x00, 0xFF), (0x00, 0x00, 0xFF)),
    "p1": ((0xFF, 0x00, 0x00), (0xFF, 0x00, 0x00)),
    "p2": ((0x00, 0xFF, 0x00), (0x00, 0xFF, 0x00)),
    "p3": ((0xFF, 0xFF, 0x00), (0xFF, 0xFF, 0x00)),
    "p4": ((0x80, 0x00, 0xFF), (0x80, 0x00, 0xFF)),
    "p5": ((0xFF, 0x80, 0x00), (0xFF, 0x80, 0x00)),
    "p6": ((0x00, 0xFF, 0xFF), (0x00, 0xFF, 0xFF)),
    "p7": ((0xFF, 0x00, 0xFF), (0xFF, 0x00, 0xFF)),
}
