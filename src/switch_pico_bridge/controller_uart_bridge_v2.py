...
PRESET_COLORS: Dict[str, Tuple[Tuple[int, int, int], Tuple[int, int, int]]] = {
    "red": ((0xFF, 0x2A, 0x2A), (0x20, 0x10, 0x10)),
    "blue": ((0x00, 0x80, 0xFF), (0x10, 0x18, 0x28)),
    "green": ((0x00, 0xD0, 0x70), (0x10, 0x20, 0x16)),
    "yellow": ((0xFF, 0xD0, 0x20), (0x30, 0x24, 0x08)),
    "orange": ((0xFF, 0x80, 0x20), (0x30, 0x18, 0x08)),
    "purple": ((0x9B, 0x5C, 0xFF), (0x18, 0x10, 0x28)),
    "pink": ((0xFF, 0x4D, 0xB8), (0x28, 0x10, 0x20)),
    "cyan": ((0x00, 0xD5, 0xFF), (0x08, 0x24, 0x28)),
    "white": ((0xF4, 0xF4, 0xF4), (0x20, 0x20, 0x20)),
    "gray": ((0x80, 0x80, 0x80), (0x18, 0x18, 0x18)),
    "black": ((0x20, 0x20, 0x20), (0xF0, 0xF0, 0xF0)),
    "p1": ((0xFF, 0x2A, 0x2A), (0x20, 0x10, 0x10)),
    "p2": ((0x00, 0x80, 0xFF), (0x10, 0x18, 0x28)),
    "p3": ((0x00, 0xD0, 0x70), (0x10, 0x20, 0x16)),
    "p4": ((0xFF, 0xD0, 0x20), (0x30, 0x24, 0x08)),
}
